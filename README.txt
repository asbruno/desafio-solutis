...
2) API - REST 
Depois de realizar o download ou de baixar a pasta "api-rest", só precisar ir ao console "cmd"
...
3.b) Já com XXXXXX.js instalado, deve-se abrir o console "cmd" e na dentro da pasta "front-end-angular" executar "npm install"
3.c) Por fim o comando "npm start", este ultimo inicia o servidor e a aplicação front-end.
3.d) Em um navegador, preferencia Firefox ou Chrome, acesse "http:/localhost:4200"
